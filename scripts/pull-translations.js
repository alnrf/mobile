...
const generate = async (locale: string) => {
  ...
  const translations: Translations = {
    ...
    noResults: formatTranslation(moocTranslations.mobile.content.noResults),
    noResultsDescription: formatTranslation(moocTranslations.mobile.content.noResultsDescription),
    ...
    search: formatTranslation(moocTranslations.mobile.content.search),
